    ...
    <div class="row">
        ...
        <div class="col-sm-12">
             <ul class="nav nav-tabs">        
                ...
                <li {{ (current_page("epotmoneyview")) ? 'class=active' : '' }}><a href="#">Pot Money</a></li>
              </ul>
                ...
                <hr>
                  <form class="form" action="" method="post" id="registrationForm" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          <div class="col-xs-3">
                              <label for="first_name"><h4>Pot Money</h4></label>
                              <input style="border:none; background:white;" value="{{ number_format($epotprize->totalprize) }}" type="text" class="form-control" name="eplayers"  placeholder="Enter Buyin" required="">
                          </div>
                      </div>
