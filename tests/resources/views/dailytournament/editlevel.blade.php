    ...
    <div class="row">
      ...
      <div class="col-sm-12">
             <ul class="nav nav-tabs">        
                ...
                <hr>
                  <form class="form" action="{{ url('/editlevel')}}/{{$level->id}}" method="post" id="registrationForm" enctype="multipart/form-data">
                           {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-4">
                              ...
                              <input style="border:none; background:white;" value="{{ gmdate('i:s', $level->in_seconds) }}" type="text" class="form-control" name="editduration"  placeholder="Enter Duration" required="">
                          </div>
                      </div>
